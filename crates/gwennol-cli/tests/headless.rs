...
/// table at all — this is the one run in this file with zero rules,
/// every other run passing at least one `--allow`. Mutation: delete
/// the `tracing::warn!` in `frontend.rs`.
#[test]
